package com.majedul.auth.presentation.intro
...
fun IntroScreen(
    ...
    GradientBackground {
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.welcome_to_majedul),
                color = MaterialTheme.colorScheme.onBackground,
                fontSize = 20.sp
            )
            Spacer(modifier = Modifier.height(8.dp))
            Text(
                text = stringResource(id = R.string.majedul_description),
...
@Composable
private fun majedulLogoVertical(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.majedul),
            fontSize = 24.sp,
