...
import com.majedul.core.presentation.designsystem.ArrowLeftIcon
...
@Preview
@Composable
private fun MajedToolbarPreview() {
    MajedTheme {
        MajedToolbar(
            showToolbar = false,
            showBackButton = true,
            ...
            menuItems = listOf(
                DropdownItem(AnalyticsIcon, "Analytics"), DropdownItem(LogoutIcon, "Logout")
            )
